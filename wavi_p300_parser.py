...
designed to parse the output files generated by a WAVI. Starting from the
directory designated from the -i option, wavi_p300_parser will search for subdirectories
