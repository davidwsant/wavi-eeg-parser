...
args = ArgumentParser('./wavi_eeg_parser.py', description="""This program has been
designed to parse the output files generated by a WAVI EEG system into csv format. Starting from the
directory designated by the -i option, wavi_eeg_parser.py will search for subdirectories
...
# 	'--output_directory',
# 	help="""
# 	This is the directory where wavi_eeg_parser.py will save the output files. By
# 	default, wavi_eeg_parser will store the files in a new directory 'Wavi_EEG_Output'.
# 	""",
# 	default="Wavi_EEG_Output"
# )
...
def error_message():
	print()
	print("""
	Welcome to wavi_eeg_parser.py. This program has been designed to parse the output
	files generated by a WAVI. Starting from the directory designated from the -i option,
	wavi_eeg_parser will search for subdirectories containing files ending in '.eeg', '.art',
	...
	""")
	print()
	print("\tExample usage: ./wavi_eeg_parser.py -i .. -o ../combined_files")
	print()
...
if len(usable_folders) == 0:
	...
	print("\tPlease try running wavi_eeg_parser.py using the -i option to specify a starting folder.")
	print()
	sys.exit(1)
